...
// This script was copied to project tmp; original plugin root:
const pluginRoot = 'C:\\Users\\jian\\.claude\\plugins\\cache\\understand-anything\\understand-anything\\2.3.1';
// const pluginRoot = resolve(__dirname, '../..'); // original relative path
...
async function main() {
  // Read input
  const inputRaw = readFileSync(resolve(inputPath), 'utf-8');
