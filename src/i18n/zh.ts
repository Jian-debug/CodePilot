...
const zh: Record<TranslationKey, string> = {
  ...
  'composer.swarmModeTooltip': '多 Agent 自主协作',

  // ── Swarm ─────────────────────────────────────────────────
  'swarm.startTitle': '启动 Swarm 模式',
  'swarm.startDescription': '多个 AI Agent 将自动协作：拆解任务、分工执行、交叉审核，直到完成目标。你只需设定目标，剩下的交给 Swarm。',
  'swarm.topology': '协作拓扑',
  'swarm.topologyHierarchical': '层级模式',
  'swarm.topologyHierarchicalDesc': 'Manager 拆解 → Worker 执行',
  'swarm.topologySequential': '流水线模式',
  'swarm.topologySequentialDesc': 'A → B → C 串行处理',
  'swarm.topologyAutonomous': '自主循环',
  'swarm.topologyAutonomousDesc': '单 Agent 迭代优化',
  'swarm.agentRoles': 'Agent 角色',
  'swarm.plannerDesc': '任务拆解 + 排期',
  'swarm.coderDesc': '编码 + 工具调用',
  'swarm.reviewerDesc': '质量审核 + 反馈',
  'swarm.qualityCheck': '质量审核循环',
  'swarm.maxIterations': '最大迭代次数',
  'swarm.autoRetry': '自动重试失败任务',
  'swarm.model': 'AI 模型',
  'swarm.recommended': '推荐',
  'swarm.noModels': '无可用模型 — 请检查 Provider 设置',
  'swarm.start': '启动 Swarm',
  'swarm.cancel': '取消',
  'swarm.running': 'Swarm 运行中',
  'swarm.topologyLabel': '拓扑',
  'swarm.iteration': '迭代',
  'swarm.elapsed': '已用时',
  'swarm.stop': '停止',
  'swarm.taskPipeline': '任务管线',
  'swarm.commLog': 'Agent 通信日志',
  'swarm.commLogEmpty': '等待 Agent 活动...',
  'swarm.agentIdle': '等待中',
  'swarm.agentPlanning': '规划中',
  'swarm.agentRunning': '运行中',
  'swarm.agentReviewing': '审核中',
  'swarm.agentCompleted': '已完成',
  'swarm.agentFailed': '失败',
  'swarm.agentStopped': '已停止',
  'swarm.taskQueued': '排队',
  'swarm.taskRunning': '执行中',
  'swarm.taskCompleted': '完成',
  'swarm.taskFailed': '失败',
  'swarm.taskWaiting': '等待',
