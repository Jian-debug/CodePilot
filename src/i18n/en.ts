...
const en = {
  ...
  'composer.swarmMode': 'Swarm',
  'composer.swarmModeTooltip': 'Multi-agent autonomous collaboration',

  // ── Swarm ─────────────────────────────────────────────────
  'swarm.startTitle': 'Start Swarm Mode',
  'swarm.startDescription': 'Multiple AI Agents will collaborate autonomously: decompose tasks, execute in parallel, and cross-review until completion. Just set the goal, and let the Swarm handle the rest.',
  'swarm.topology': 'Collaboration Topology',
  'swarm.topologyHierarchical': 'Hierarchical',
  'swarm.topologyHierarchicalDesc': 'Manager decomposes → Workers execute',
  'swarm.topologySequential': 'Pipeline',
  'swarm.topologySequentialDesc': 'A → B → C sequential processing',
  'swarm.topologyAutonomous': 'Autonomous',
  'swarm.topologyAutonomousDesc': 'Single agent iterative optimization',
  'swarm.agentRoles': 'Agent Roles',
  'swarm.plannerDesc': 'Task decomposition & planning',
  'swarm.coderDesc': 'Coding & tool execution',
  'swarm.reviewerDesc': 'Code review & quality check',
  'swarm.qualityCheck': 'Quality review cycle',
  'swarm.maxIterations': 'Max iterations',
  'swarm.autoRetry': 'Auto-retry failed tasks',
  'swarm.model': 'AI Model',
  'swarm.recommended': 'Recommended',
  'swarm.noModels': 'No models available — check provider settings',
  'swarm.start': 'Start Swarm',
  'swarm.cancel': 'Cancel',
  'swarm.running': 'Swarm Running',
  'swarm.topologyLabel': 'Topology',
  'swarm.iteration': 'Iteration',
  'swarm.elapsed': 'Elapsed',
  'swarm.stop': 'Stop',
  'swarm.taskPipeline': 'Task Pipeline',
  'swarm.commLog': 'Agent Communication Log',
  'swarm.commLogEmpty': 'Waiting for agent activity...',
  'swarm.agentIdle': 'Idle',
  'swarm.agentPlanning': 'Planning',
  'swarm.agentRunning': 'Running',
  'swarm.agentReviewing': 'Reviewing',
  'swarm.agentCompleted': 'Completed',
  'swarm.agentFailed': 'Failed',
  'swarm.agentStopped': 'Stopped',
  'swarm.taskQueued': 'Queued',
  'swarm.taskRunning': 'Running',
  'swarm.taskCompleted': 'Done',
  'swarm.taskFailed': 'Failed',
  'swarm.taskWaiting': 'Waiting',
