...
const en = {
  ...
  'settings.workflowTitle': 'Dynamic Workflows',
  'settings.workflowAutoSuggestTitle': 'Suggest workflows',
  'settings.workflowAutoSuggestDesc': 'For large, multi-step tasks, hint the assistant to use the Workflow tool (plans steps, verifies each, retries on a stronger model). The assistant still decides.',
  'settings.workflowConcurrencyTitle': 'Max parallel steps',
  'settings.workflowConcurrencyDesc': 'How many independent workflow steps may run at once. Dependent steps always wait. Use 1 to run serially.',
  'settings.workflowConcurrencySerial': '1 (serial)',
  'settings.workflowRetriesTitle': 'Step retry attempts',
  'settings.workflowRetriesDesc': 'After a step exhausts its model ladder, how many extra times it retries on the strongest model (with the verifier\'s feedback) before failing.',
  'settings.workflowRetriesNone': '0 (off)',
  'settings.workflowMaxDepthTitle': 'Decompose hard steps',
  'settings.workflowMaxDepthDesc': 'When a hard step fails even on the strongest model, break it into a sub-workflow. This is the max nesting depth (0 disables it).',
  'settings.workflowMaxDepthOff': '0 (off)',
